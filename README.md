...
✔️ Scalable ETL pipeline using **Python & PostgreSQL**  
✔️ Containerized with Docker  
🔗 [View Project](https://github.com/MAHMOUD-SHAHBA/Employee_Management_System_Python.git)
...
🔗 [In Progress](https://github.com/MAHMOUD-SHAHBA/MAHMOUD-SHAHBA/blob/main/README.md)

---

### 🔹 Analytics Dashboards
✔️ Data visualization with Python & Tableau  
✔️ Business insights from real datasets  

- 🔗 [Blinkit Analysis](https://github.com/MAHMOUD-SHAHBA/Blinkit--Analysis.git)  
- 🔗 [Pizza Sales Analysis](https://github.com/MAHMOUD-SHAHBA/Pizza_Sales_Pandas.git)  
- 🔗 [London Bike Analysis](https://github.com/MAHMOUD-SHAHBA/London-Bike-Analysis.git)

---

## 📈 Current Focus
- 🔄 Building **production-grade data pipelines**
- ⚡ Learning **Apache Airflow & Spark**
- 🤖 Moving toward **Machine Learning Engineering**
...
- 🟢 WhatsApp: https://wa.me/201008040778  

---

## ⚡ Fun Fact
I turn **mathematical thinking into scalable engineering solutions**.
